 ...
 */
export const ORCHESTRATOR_MODEL_RECOMMENDATION = "opencode/glm-4.7-free"
...
export const BUDGET_TIERS: Record<BudgetTier, BudgetTierConfig> = {
  ...
  cheap: {
    ...
    models: {
      ...
      thinking: "github-copilot/gpt-4o",       // GPT-4o for thinking (gpt-4o-mini not available via Copilot)
  ...
  moderate: {
    ...
    models: {
      ...
      judge: "github-copilot/gpt-4o",             // GPT-4o as judge (gpt-4o-mini not available via Copilot)
    },
